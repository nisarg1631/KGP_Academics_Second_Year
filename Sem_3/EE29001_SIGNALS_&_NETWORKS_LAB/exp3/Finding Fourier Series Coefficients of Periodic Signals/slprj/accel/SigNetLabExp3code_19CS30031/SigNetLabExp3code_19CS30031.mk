...
MODEL                = SigNetLabExp3code_19CS30031
MODULES              = 
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/SigNetLabExp3code_19CS30031_acc.mexw64
MAKEFILE             = SigNetLabExp3code_19CS30031.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:/Users/nisar/My Files/IIT Kharagpur/SecondYear/Signet/LAB/exp3/FINDIN~1
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 6
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SigNetLabExp3code_19CS30031_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/SigNetLabExp3code_19CS30031 \
